...
- **Tech**: PHP 7/8, MySQL, HTML5, CSS3 (Glassmorphism), Vanilla JS.
...
2.  **Configuration**:
    ...
    - Update `APP_URL` if your project path is different from `http://localhost/bonGravity`.

3.  **Run**:
    - Open your browser to `http://localhost/bonGravity/index.php`.
